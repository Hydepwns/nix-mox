...
def print_help [] {
    ...
    print "=================="
    print ""
    print "Usage: nu -c 'source scripts/testing/run-tests.nu; run [OPTIONS]'"
    print ""
    print "Options:"
    ...
    print ""
    print "Examples:"
    print "  nu -c 'source scripts/testing/run-tests.nu; run [\"--unit\"]'"
print "  nu -c 'source scripts/testing/run-tests.nu; run [\"--verbose\", \"--integration\"]'"
print "  nu -c 'source scripts/testing/run-tests.nu; run [\"--no-coverage\", \"--parallel\"]'"
print "  nu -c 'source scripts/testing/run-tests.nu; run [\"--display\"]'"
}
