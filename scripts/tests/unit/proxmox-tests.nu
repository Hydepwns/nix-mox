#!/usr/bin/env nu
# Unit tests for proxmox-update.nu script
...
def test_check_root [] {
    ...
    # Test non-root user (should fail)
    ...
    # Test the logic of root checking
...
def test_append_to_log [] {
    ...
    # Test append-to-log error handling
...
def test_command_validation [] {
    ...
    # Test pveupdate command availability
    ...
    # Test pveupgrade command availability
...
def test_error_handling [] {
    ...
    # Test log write failure handling
