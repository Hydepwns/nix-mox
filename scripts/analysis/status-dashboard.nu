...
if ($test_coverage_file | path exists) {
    ...
    print "║   Run: nu scripts/testing/run-tests.nu                                    ║"
}
print "║                                                                              ║"

# Available Commands
print "║ 🛠️  Available Commands                                                       ║"
print "║   Health Check:     nu scripts/maintenance/health-check.nu                         ║"
print "║   Run Tests:        nu scripts/testing/run-tests.nu                           ║"
print "║   Unified Setup:    nu scripts/setup/unified-setup.nu                        ║"
print "║   Project Cleanup:  nu scripts/maintenance/cleanup.nu                            ║"
