...
def main [
    ...
    info $"nix-mox setup: Running ($mode) setup for ($component)" --context $context
...
def setup_base_system [config: record, dry_run: bool] {
    info "Starting base system setup" --context "setup"
...
def setup_core_system [config: record, dry_run: bool] {
    info "Starting core system setup" --context "setup"
...
def setup_gaming_system [config: record, dry_run: bool] {
    info "Starting gaming system setup" --context "setup"
...
def setup_development_system [config: record, dry_run: bool] {
    info "Starting development system setup" --context "setup"
...
def setup_chezmoi_system [config: record, dry_run: bool] {
    info "Starting chezmoi system setup" --context "setup"
...
def setup_display_system [config: record, dry_run: bool] {
    info "Starting display system setup" --context "setup"
...
def setup_audio_system [config: record, dry_run: bool] {
    info "Starting audio system setup" --context "setup"
...
def setup_performance_system [config: record, dry_run: bool] {
    info "Starting performance system setup" --context "setup"
...
def setup_testing_system [config: record, dry_run: bool] {
    info "Starting testing system setup" --context "setup"
...
def setup_analysis_system [config: record, dry_run: bool] {
    info "Starting analysis system setup" --context "setup"
...
# Use: nu setup.nu <mode> [options] instead