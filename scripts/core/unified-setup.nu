...
NIXMOX_GIT_EMAIL=($git_email)"
    ...
    print "   nix-shell -p nushell --run 'nu scripts/core/safe-rebuild.nu'"
}
...
def setup_gaming [non_interactive: bool = false] {
    ...
    print "1. Build system: nix-shell -p nushell --run 'nu scripts/core/safe-rebuild.nu'"
...
def show_help [] {
    ...
    print ""
    print "Usage:"
    print "  nu scripts/core/unified-setup.nu                     # Interactive setup"
    print "  nu scripts/core/unified-setup.nu --type personal     # Direct setup type"
    print "  nu scripts/core/unified-setup.nu --non-interactive   # Non-interactive mode"
    print "  nu scripts/core/unified-setup.nu --help              # Show this help"
    print ""
    print "Setup Types:"
    ...
    print ""
    print "Examples:"
    print "  nu scripts/core/unified-setup.nu --type gaming"
    print "  nu scripts/core/unified-setup.nu --non-interactive --type server"
}
