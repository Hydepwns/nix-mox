...
def main [
    ...
    if $install_result.success {
        ...
        print "   nix-shell -p nushell --run 'nu scripts/core/unified-setup.nu'"
        print ""
        print "2. Or run configuration setup separately:"
        print "   nix-shell -p nushell --run 'nu scripts/core/simple-setup.nu'"
        print ""
...
def show_help [] {
    ...
    print "  nu scripts/core/unified-setup.nu     # Unified setup (RECOMMENDED)"
    print "  nu scripts/core/simple-setup.nu      # Simple setup (alternative)"
}