...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    echo "🔧 Testing Tools"
    echo "--------------"
    echo "1. BATS (Bash Automated Testing):"
    echo "   # Run all tests"
    echo "   bats tests/"
    echo ""
    ...
    echo "----------------------"
    echo "1. BATS Test Example (test_example.bats):"
    ...
    echo "   }"
    echo ""
    echo "2. ShellSpec Example (spec_example.sh):"
    echo "   Describe 'example'"
    echo "     It 'performs addition'"
    echo "       When call add 2 2"
    echo "       The output should eq '4'"
    echo "     End"
    echo "   End"
    echo ""
